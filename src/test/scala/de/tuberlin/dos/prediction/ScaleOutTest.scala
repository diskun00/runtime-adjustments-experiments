package de.tuberlin.dos.prediction

import de.tuberlin.dos.adjustments.{Args, StageScaleOutPredictor}
...
class ScaleOutTest extends FlatSpec{
  ...
  def test_run(args: Array[String]): Unit = {
    ...
    val sparkConf = new SparkConf()
      ...
      .set("spark.extraListeners", "de.tuberlin.dos.spark.StageScaleOutPredictor") // this makes sure the 'app start' event is called
